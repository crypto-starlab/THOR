...
ext_modules_cs = [
    CUDAExtension(
        name="create_switcher_cuda",
        sources=[
            "src/liberate/fhe/create_switcher/create_switcher_cuda.cpp",
            "src/liberate/fhe/create_switcher/create_switcher_cuda_kernel.cu",
        ],
    )
]
...
if __name__ == "__main__":
    ...
    setup(
        ...
        ext_modules=ext_modules_cs,
        script_args=["build_ext"],
        cmdclass={"build_ext": BuildExtension},
        options={
            "build": {
                "build_lib": "src/liberate/fhe/create_switcher",
            }
        },
    )
